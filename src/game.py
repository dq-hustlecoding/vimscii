...
class Vimscii:
    ...
    def draw_screen(self):
        ...
        if self.is_insert_mode:
            print(self.term.move(cursor_y, cursor_x) + self.term.reverse(' '), end='', flush=True)
        else:
            print(self.term.move(cursor_y, cursor_x) + self.term.underline(' '), end='', flush=True)
    ...
    def show_result_screen(self, success: bool):
        ...
        if success:
            ...
            messages = [
                ...
                f"Best: {best_time:.2f} seconds" if best_time != float('inf') else "New stage record!",
